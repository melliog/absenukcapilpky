   ...
   <script src="assets/jquery-3.7.0.js"></script>
         ...
         <div class="col-12">
               <div class=" alert alert-primary ">
                  <div class="card-body">
                     ...
                     <a href="tambah_data_karyawan.php" class="btn btn-outline-success btn-sm float-end">Tambah</a>
                  </div>
               </div>
         </div>
            <hr>
            <div style="overflow-x:auto;">
                  ...
                  <table id="myTable" class="table table-bordered table-stiped alert-primary" >
                     <thead  class="alert alert-primary" class="text-justify">
                            ...
                            <!-- <?php $nama = $conn->query("SELECT * FROM data_karyawan") ?> -->
    ...
    ?>
            <tr>
                ...
                <td>
                <a class="btn btn-sm btn-danger text-white" href="proses/hapus_karyawan.php?id_karyawan=<?= $data['id_karyawan'] ?>" 
                    onclick="return confirm('Hapus Data?');">Hapus</a> 
                    <a class="btn btn-sm btn-warning text-white" href="from_edit_karyawan.php?id_karyawan=<?= $data['id_karyawan'] ?>">edit</a>
                </td>
