            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="card alert rounded-0 border-0 ">
                    <div class="card-body">
                        ...
                        <span class="display-5 fw-bold text-center">EDIT DATA ABSEN DATANG</span>
                        </div>
                        <hr>

                        <?php $nama = $conn->query("SELECT * FROM data_absen WHERE id = '$id'"); 
    ?>
    <?php foreach($nama as $data) : ?> 

                        <form action="proses/edit_datang.php" method="post">
                        <div class="mb-2">
