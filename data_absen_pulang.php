   ...
   <script src="assets/jquery-3.7.0.js"></script>
      ...
      <div class="container-fluid">
         ...
         <div class="col-12">
               <div class=" alert alert-primary ">
                  <div class="card-body">
                     <span class="fw-bold">DATA ABSEN PULANG</span>
                  </div>
               </div>
         </div>
            <hr>
    ...
    ?>
            <tr>
                ...
                <td>
                <a class="btn btn-sm btn-danger text-white" href="proses/hapus_absen_pulang.php?id=<?= $data['id'] ?>" 
                    onclick="return confirm('Hapus Data?');">Hapus</a> 
                    <a class="btn btn-sm btn-warning text-white" href="from_edit_absen_p.php?id=<?= $data['id'] ?>">edit</a>
