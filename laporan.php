      ...
      <div class="container-fluid">
         ...
         <div class="col-12">
               <div class=" alert alert-primary ">
                  <div class="card-body">
                     <span class="fw-bold">DATA LAPORAN ABSEN PULANG & DATANG</span>
                  </div>
               </div>
         </div>
            <hr>
            ...
            <a href="lprn/xls.php" class="btn btn-sm btn-success mb-2">Xls</a>
            <a href="lprn/pdf.php" class="btn btn-sm btn-danger mb-2 mx-2">PDF</a>
