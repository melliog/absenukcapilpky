            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="card alert rounded-0 border-0 ">
                    <div class="card-body">
                        ...
                        <span class="display-5 fw-bold text-center">EDIT DATA ABSEN PULANG</span>
                        </div>
                        <hr>

                        <?php $nama = $conn->query("SELECT * FROM data_absen_pulang WHERE id = '$id'"); 
    ?>
    <?php foreach($nama as $data) : ?> 


                        <form action="proses/edit_pulang.php" method="post">
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="time" name="waktu" id="waktu" class="form-control" value="<?= $data['waktu'] ?>">
                            </div>
                            <div class="mb-2">
                            ...
                            <br>
                            <div class="mb-2">
                                <label for="nama" class="form-label" value="<?= $data['keterangan'] ?>">Keterangan</label>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="detail_keterangan" id="detail_keterangan" class="form-control" value="<?= $data['detail_keterangan'] ?>">
                            </div>
